...
(globalThis as typeof globalThis & { logger: typeof consola }).logger = consola.withTag("repair-event-ingested-at")
...
async function main() {
  ...
  await table.init()
  const ingestRepair = await table.repairInitialCanonicalIngestedAt(options)
